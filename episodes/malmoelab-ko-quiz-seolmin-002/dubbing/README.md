...
```bash
/home/kindsr/projects/shortform-factory-studio/.venv-render/bin/python scripts/pilot/render_daehan_pilot_keyframe_review_v1.py --episode-dir episodes/malmoelab-ko-quiz-seolmin-002 --env-file .env
```
