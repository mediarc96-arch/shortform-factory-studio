...
PREP_SCRIPT = SCRIPT_DIR / "prepare_pet_contents_scene_jobs.py"
ORCHESTRATE_SCRIPT = SCRIPT_DIR / "orchestrate_scenes.py"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the pet-contents storyboard render pipeline through picture preview.")
...
def main() -> int:
    ...
    run(
        [
            ...
            "--job-file",
            str(episode_dir / "scene-orchestration-job.json"),
            "--env-file",
            str(env_file),
            "--python-bin",
            python_bin,
